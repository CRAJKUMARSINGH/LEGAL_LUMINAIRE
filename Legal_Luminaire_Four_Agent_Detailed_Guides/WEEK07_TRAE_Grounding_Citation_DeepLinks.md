...
- [ ] 100% of TC-01 citations (draft + copilot) resolve to a real source locator in one click
- [ ] TC-E07 fake citations impossible; refusal path proven
- [ ] Contradiction questions return both contradicting items with ids
- [ ] Clean-clone Netlify deploy succeeds; `WEEK07_TRAE_COMPLETION.md` committed
