...
* Focusing on what is best not just for us as individuals, but for the overall
  community
* When speaking with accuracy and rigor, especially in discussions that involve legal
  citations, forensic standards, and factual assertions
...
* Knowingly sharing fabricated or unverified legal citations or technical assertions
  (see the project's accuracy governance rules)
...
the community leaders responsible for enforcement **via GitHub Issues by opening
an issue and tagging the maintainer `@CRAJKUMARSINGH`.
