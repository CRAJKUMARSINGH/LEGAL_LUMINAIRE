...
**Input Files:** `test-cases/CASE_01_HemrajG/input-documents/`
**Expected Behaviour:**
...
**Input Files:** `test-cases/CASE_02_BailNDPS/input-documents/`
**Expected Behaviour:**
...
**Input Files:** `test-cases/CASE_03_ChequeDischarge/input-documents/`
**Expected Behaviour:**
