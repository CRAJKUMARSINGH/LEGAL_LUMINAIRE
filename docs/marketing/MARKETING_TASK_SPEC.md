...
|----------------|-----------------|-------------|
| Building collapse demo | TC-01 | test-cases/CASE01_HEMRAJ_STATE_2025/ |
| NDPS bail demo | TC-02 | test-cases/CASE02_RAMESH_STATE_2025/ |
| NI Act discharge demo | TC-03 | test-cases/CASE03_APEX_SUNIL_2025/ |
