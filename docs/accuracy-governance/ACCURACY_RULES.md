...
## 10. SYNTHETIC / DEMO DATA LABELLING

- All imaginary/demo documents MUST be labelled: `[SYNTHETIC TEST DATA — NOT REAL]`
- All demo citations MUST be labelled: `[DEMO PLACEHOLDER — VERIFY BEFORE FILING]`
- No synthetic data may be presented as real case outcomes.

---

*This file supersedes ACCURACY_GUIDELINES.md. Both are maintained for traceability.*
