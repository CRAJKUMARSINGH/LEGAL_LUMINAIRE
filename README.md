...
**How to Use LegalDraft AI:**

1. Place all case-related documents (PDFs, images, text files, previous orders, etc.) inside the case folder.
   - **Folder Management Naming Standard:** Ensure your folder is properly formatted as: `CASENO_PARTY1_PARTY2_YEAR`. 
   - *Example:* `CASE02_PITAMBARA_ROOPAM_2026`
2. Place any new code improvements or updated modules inside: `UPDATE FOR PITAMBRA`
3. Run the application. 
4. The AI will automatically:
   - Read every file from the input case folder.
   - Integrate latest code enhancements.
   - Generate a high-quality draft reply / written statement.
5. Review the generated draft, make minor changes if needed, and save as final.

**Important Notes:**
- Always keep the folder structure intact and adhere strictly to the `CASENO_PARTY1_PARTY2_YEAR` naming rule.
- New case details will be automatically picked up from the input folder only.
- No manual copy-paste of facts is required — the app reads files directly.
- Output will be in clean, editable Word/PDF-ready format with proper legal numbering.
